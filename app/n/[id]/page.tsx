...
import { BookOpen, Clock, List, ChevronRight, Home } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 pb-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 flex flex-col md:flex-row gap-8 mb-6">
            <div className="w-40 flex-shrink-0 mx-auto md:mx-0">
               <img src={book.coverUrl} className="w-full rounded shadow-md border" />
            </div>
            ...
            <div className="flex-1">
               ...
               <div className="flex gap-4">
                  ...
                  <button className="border border-gray-300 hover:bg-gray-50 text-gray-700 px-6 py-2.5 rounded text-sm font-medium transition">
                    加入书架
                  </button>
               </div>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-0">
              {Array.from({length: 30}).map((_, i) => (
                ...
                >
                   第{101 + i}章 这是一个模拟的章节标题 {i+1}
                </Link>
              ))}
           </div>
           
           <div className="mt-6 text-center">
              <button className="bg-gray-100 text-gray-600 px-6 py-2 rounded text-sm hover:bg-gray-200 transition">
                  查看全部章节 ↓
              </button>
           </div>
        </div>
